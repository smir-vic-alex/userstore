...
<bean:define id="form" name="ClientAddVKProfileActionForm"/>
...
<tiles:insert definition="main" flush="false">
    ...
    <tiles:put name="data" type="string">
        ...
        <h2>Из-за правил вконтакте необходимо вручную </h2>
        <h2>предоставить специальный код авторизации</h2>
        <div class="content-row">
            <html:form action="/private/client/vk/get/code">
